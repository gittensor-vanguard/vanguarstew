...
def test_render_truncation_preserves_valid_json_and_all_judged_fields():
    # Overload must stay valid JSON within budget and keep every judged axis present.
    # Structural abridgement (not opaque json_prefix stubs) may also set ``_abridged``.
    rendered = _render({
