...
artifacts and the ``scored_repos: 0`` placeholder, series / entry coercion, the trend summary
(points, deltas, first/last, regressions), the one-line headline, and pure evaluation — deep
non-mutation across every input shape plus a no-I/O assertion. Offline, deterministic; every
assertion is pinned against the as-built module's live output.
"""
