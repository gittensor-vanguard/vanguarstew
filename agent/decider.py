...
def _is_planning_request(request: str) -> bool:
    ...
    planner's window note recognize exactly the same templates — inlining the check in both is
    what let them diverge (this guard was fixed in #1772 while the planner saw nothing).
    """
