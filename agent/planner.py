...
# Mirrors benchmark/score.py release-subject detection (agent/ must not import benchmark/).
...
_RELEASE_PRESSURE_MIN_COMMITS = 5
_RELEASE_PRESSURE_MIN_DAYS = 7.0
...
def _release_pressure(context: dict) -> bool:
    """True when frozen context shows release-cadence pressure (not just shipped, building)."""
