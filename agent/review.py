...
# Keep markers specific to the rubric axis — bare "redundant" alone is too broad and would
# downgrade merges that mention an unrelated redundancy nit (#1788/#1897 score-noise risk).
