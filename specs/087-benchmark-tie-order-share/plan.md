...
| Tie-order share headline | `test_headline_with_counts_exact_format`, `test_headline_zero_total_shows_unavailable`, `test_headline_none_share_shows_na`, `test_headline_nan_share_shows_na`, `test_headline_non_dict_summary_coerced` |
...
`tests/test_tie_order_share.py`. The contract tests assert the as-built module already satisfies
