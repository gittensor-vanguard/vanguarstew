...
| Inference | `test_infer_philosophy_non_dict_context_skips_the_llm_entirely`, `test_infer_philosophy_calls_chat_json_once_with_the_stub`, `test_infer_philosophy_normalizes_an_unusable_payload`, `test_infer_philosophy_prompt_carries_the_documented_sections`, `test_context_philosophy_stub_derives_from_readme_and_commits`, `test_context_philosophy_stub_without_signals_is_mode_honest` |
