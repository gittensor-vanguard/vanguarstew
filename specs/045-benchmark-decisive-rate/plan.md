...
| Tally parsing | `test_tally_counts_happy_path`, `test_tally_counts_missing_or_malformed`, `test_tally_counts_judge_report_fallback`, `test_tally_counts_tally_precedence_over_judge_report`, `test_tally_counts_judge_report_malformed` |
