...
def _is_number(value) -> bool:
    ...
    # matching benchmark/row_integrity.py (#616/#927). math.isfinite also raises OverflowError
    # for ints too large for a float, which would crash int()/formatting the same way.
