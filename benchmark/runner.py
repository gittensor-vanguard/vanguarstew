    ...
    try:
        for repo in selected:
            ...
            try:
                ...
                # One unusable repo must not abort the batch; record it like a zero-task repo
                # so the tasks > 0 gate below excludes it from the mean and counts it in skipped.
                logger.warning("runner: replay failed for %s: %s", repo.get("repo"), exc)
