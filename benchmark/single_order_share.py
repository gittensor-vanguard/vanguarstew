"""Report the single-presentation share from a replay artifact's judge order stats.
...
summarize_single_order_share, single_order_share_headline, _slice_summary = make_order_share(
    numerator_keys=("single",),
    count_field="single",
    share_field="single_order_share",
    headline_label="single-order share",
)

__all__ = [
    "summarize_single_order_share", "single_order_share_headline", "_slice_summary",
