...
summarize_disagree_order_share, disagree_order_share_headline, _slice_summary = make_order_share(
    numerator_keys=("disagree",),
    count_field="disagree",
    share_field="disagree_order_share",
    headline_label="disagree-order share",
)

__all__ = [
    "summarize_disagree_order_share", "disagree_order_share_headline", "_slice_summary",
