...
``disagreement_outlook`` reports ``disagreement_rate`` among dual-order tasks; this read-only
utility reports how many categorized judge outcomes ended in disagreement (``disagree / total`` in
