"""Report the offline outcome share from a replay artifact's judge order stats.
...
summarize_offline_share, offline_share_headline, _slice_summary = make_order_share(
    numerator_keys=("offline",),
    count_field="offline",
    share_field="offline_share",
    headline_label="offline share",
)

__all__ = [
    "summarize_offline_share", "offline_share_headline", "_slice_summary",
