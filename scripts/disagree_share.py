"""CLI: print position-disagreement share from a replay artifact.
...
def run(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Report position-disagreement share from judge stats")
