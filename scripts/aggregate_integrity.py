...
Exit codes are distinct so a CI gate can tell the two apart: **1** means the gate failed, **2**
means the artifact could not be read (see ``scripts.artifact_io``).
"""
...
from scripts.artifact_io import load_artifact
